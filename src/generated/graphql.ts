...
export type DynamicComponentFormat =
...
export type HistogramDataIntervalEnum =
  /** Monthly interval */
  | 'DAILY'
  /** Monthly interval */
  | 'MONTHLY'
...
export type NotificationRegistrationPush =
...
export type PriceListCharge = {
  ...
  avalaraAfcSaleType?: Maybe<Scalars['String']['output']>;
  avalaraAfcServiceType?: Maybe<Scalars['String']['output']>;
  avalaraAfcTransactionType?: Maybe<Scalars['String']['output']>;
...
export type PriceListChargeAttributes = {
  ...
  avalaraAfcSaleType?: InputMaybe<Scalars['String']['input']>;
  avalaraAfcServiceType?: InputMaybe<Scalars['String']['input']>;
  avalaraAfcTransactionType?: InputMaybe<Scalars['String']['input']>;
  billingPeriod?: InputMaybe<BillingPeriod>;
...
export type TrialExpirationAction =
...
export type WorkflowJobLogStatus =
  /** Completed */
  | 'COMPLETED'
  /** Initializing */
  | 'INITIALIZING'
